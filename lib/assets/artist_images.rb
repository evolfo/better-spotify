def artists
	artists = {
	"Angelo Spampinato" => {
		img_url: "https://pbs.twimg.com/profile_images/921892403413319680/uvT5GbIn_400x400.jpg",
		bio: "At the age of two Angelo began obsessively watching drum instructional videos, much to his mother’s surprise. Not much has changed since. Angelo graduated cum laude from the Berklee College of Music and as a student recieved multiple university awards. His drumming has taken him across the globe, performing in four continents. Here in North America, he has played at many music festivals--including but not limited to: Hardly Strictly Bluegrass, SXSW, and Canadian Music Week. He currently resides in Brooklyn and performs regularly with Iris Lune, Cale Hawkins, Shubh Saran, and less regularly with many more. He wishes he had the space in his apartment for a Newfoundland dog."
	},
	"Iris Lune" => {
		img_url: "https://photos.smugmug.com/Work/2018/Iris-Lune-photoshoot-Edited/n-8vCdgW/i-6KvM7Q6/0/c407c18d/2134x1440/i-6KvM7Q6-2134x1440.jpg",
		bio: "Pop without boundaries. A foray into the cross-pollination of electronic and acoustic, the band builds off of Vocalist Ella Joy Meir’s roots in Middle Eastern and Israeli folk music to craft a sound that stretches into the surreal."
	},
	"Shubh Saran" => {
		img_url: "https://static.wixstatic.com/media/a98f6c_ace07abf54854b5d8b16ced01b84000d~mv2_d_4164_2766_s_4_2.jpg/v1/fill/w_764,h_626,al_c,q_85,usm_0.66_1.00_0.01/a98f6c_ace07abf54854b5d8b16ced01b84000d~mv2_d_4164_2766_s_4_2.webp",
		bio: "Shubh Saran is a New York-based Indian guitarist and composer who has performed extensively as a solo artist and sideman in the United States, India, Canada, Bangladesh, Vietnam and Mexico. Having grown up in six different countries, his career has been shaped by a mixture of influences. Shubh’s intricate compositions fuse sounds from modern jazz, neo-soul, and rock with classical and contemporary Indian music."
	},
	"Evolfo" => {
		img_url: "https://image-ticketfly.imgix.net/00/02/44/88/06-og.jpg?w=500&h=334&fit=crop&crop=top",
		bio: "garage soul / rat rock band living in Brooklyn"
	},
	"Ahmad Jamal" => {
	...
	"Little Dragon" => {
		img_url: "https://media2.fdncms.com/stranger/imager/u/original/26086531/littledragonbymarcovanrijt.jpg",
		bio: "Little Dragon are a Swedish electronic music band from Gothenburg, formed in 1996. The band consists of Yukimi Nagano, Erik Bodin, Fredrik Wallin and Håkan Wirenstrand. Little Dragon's first release was the double A-side seven-inch vinyl single 'Twice/Test', released on the Off the Wall label in 2006."
	},
	"Nick Hakim" => {
		img_url: "https://read-static.tidal.com/wp-content/uploads/2017/07/13120706/Nick-Hakim_By-Shervin-Lainez-copy-640x360.jpg",
		bio: "The music of Nick Hakim occupies a space and time that is faintly out of this world. The guitars and machinery that make up his music feel slightly askew, as though someone slowed down the tape machine every once in a while. His raspy voice feels drenched in a cavernous space."
	},
	"Sampha" => {
	...
	"Queen" => {
    img_url: "https://i.pinimg.com/originals/b8/1d/3f/b81d3f9b77b507b77ba14a453d08d346.jpg",
  ...
  "Stromae" => {
    img_url: "https://pbs.twimg.com/profile_images/988358784711094272/GUnzmMwz_400x400.jpg",
    bio: "Paul Van Haver (born 12 March 1985), better known by his stage name Stromae, is a Belgian musician, rapper and singer-songwriter. He established himself in both the hip hop and electronic music genres. Stromae came to wide public attention in 2009 with his song 'Alors on danse' (from the album Cheese), which became a number one in several European countries. In 2013, his second album Racine carrée was a commercial success, selling 2 million copies in France[1] alone and nearly 600,000 units elsewhere.He has sold over 8.5 million records worldwide. His music is primarily sung in French."
  },
  ...
  "Tash Sultana" => {
    img_url: "https://cdn.baeblemusic.com/bandcontent/tash_sultana/tash_sultana-498.jpg",
  ...
  "Postmodern Jukebox" => {
    img_url: "https://images-na.ssl-images-amazon.com/images/I/61EaifCZ%2B3L.jpg",
  ...
  "Earth, Wind & Fire" => {
    img_url: "https://ichef.bbci.co.uk/news/624/cpsprodpb/1654F/production/_88117419_76960ec5-e7af-4146-b41c-7e3ed57f1af8.jpg",
    bio: "Earth, Wind & Fire (abbreviated as EWF or EW&F) is an American band that has spanned the musical genres of R&B, soul, funk, jazz, disco, pop, rock, dance, Latin, and Afro pop. They have been described as one of the most innovative and commercially successful acts of all time. Rolling Stone called them 'innovative, precise yet sensual, calculated yet galvanizing' and declared that the band 'changed the sound of black pop'. VH1 has also described EWF as 'one of the greatest bands' ever."
  },
